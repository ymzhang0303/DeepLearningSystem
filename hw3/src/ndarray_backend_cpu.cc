...
template <typename T>
void EwiseFunc(const AlignedArray& a, const AlignedArray& b, AlignedArray* out, T func) {
  /**
   * Set entries in out to be the result of applying func to corresponding entries in a and b.
   */
  for (size_t i = 0; i < a.size; i++) {
...
template <typename T>
void ScalarFunc(const AlignedArray& a, scalar_t val, AlignedArray* out, T func) {
  /**
   * Set entries in out to be the result of applying func to corresponding entry in a and the scalar
   * val.
   */
  for (size_t i = 0; i < a.size; i++) {
...
template<typename T>
void SingleEwiseFunc(const AlignedArray& a, AlignedArray* out, T func) {
  /**
   * Set entries in out to be the result of applying func to corresponding entries in a.
   */
  for (size_t i = 0; i < a.size; i++) {
...
scalar_t Sub(scalar_t a, scalar_t b) { return a - b; }
...
void ScalarMul(const AlignedArray& a, scalar_t val, AlignedArray* out) {
   ...
   */
  /// BEGIN SOLUTION
  ScalarFunc(a, val, out, Mul);
  /// END SOLUTION
}

void EwiseDiv(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be the quotient of correspondings entires in a and b.
   */
  /// BEGIN SOLUTION
  EwiseFunc(a, b, out, Div);
  /// END SOLUTION
}

void ScalarDiv(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be the quotient of corresponding entry in a and the scalar val.
   */
  /// BEGIN SOLUTION
  ScalarFunc(a, val, out, Div);
  /// END SOLUTION
}
...
void ScalarMaximum(const AlignedArray& a, scalar_t val, AlignedArray* out) {
   ...
   */
  /// BEGIN SOLUTION
  ScalarFunc(a, val, out, Max);
  /// END SOLUTION
}

void EwiseEq(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if the corresponding entries in a and b are equal, and 0 otherwise.
   */
  /// BEGIN SOLUTION
  EwiseFunc(a, b, out, Eq);
  /// END SOLUTION
}

void ScalarEq(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if the corresponding entry in a is equal to the scalar val, and 0
   * otherwise.
   */
  /// BEGIN SOLUTION
  ScalarFunc(a, val, out, Eq);
  /// END SOLUTION
}

void EwiseGe(const AlignedArray& a, const AlignedArray& b, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if the corresponding entries in a is greater than or equal to the
   * corresponding entry in b, and 0 otherwise.
   */
  /// BEGIN SOLUTION
...
void ScalarGe(const AlignedArray& a, scalar_t val, AlignedArray* out) {
  /**
   * Set entries in out to be 1 if the corresponding entry in a is greater than or equal to the
   * scalar val, and 0 otherwise.
   */
  /// BEGIN SOLUTION
...
void EwiseLog(const AlignedArray& a, AlignedArray* out) {
  /**
   * Set entries in out to be the log of the corresponding entry in a.
   */
  /// BEGIN SOLUTION
  SingleEwiseFunc(a, out, Log);
  /// END SOLUTION
}

void EwiseExp(const AlignedArray& a, AlignedArray* out) {
  /**
   * Set entries in out to be the exp of the corresponding entry in a.
   */
  /// BEGIN SOLUTION
  SingleEwiseFunc(a, out, Exp);
  /// END SOLUTION
}

void EwiseTanh(const AlignedArray& a, AlignedArray* out) {
  /**
   * Set entries in out to be the tanh of the corresponding entry in a.
   */
  /// BEGIN SOLUTION
  SingleEwiseFunc(a, out, Tanh);
  /// END SOLUTION
}
...
void ReduceMax(const AlignedArray& a, AlignedArray* out, size_t reduce_size) {
  ...
  for (int i = 0; i < out->size; i++) {
    int j = i * reduce_size;
    scalar_t max_val = a.ptr[j];
    for (int k = 0; k < reduce_size; k++) {
      max_val = std::max(max_val, a.ptr[j + k]);
    }
    out->ptr[i] = max_val;
  }
  /// END SOLUTION
